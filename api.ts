...
export type CDNStatusEnum = typeof CDNStatusEnum[keyof typeof CDNStatusEnum];
export const CDNPermissionEnum = {
    Public: 'public',
    Private: 'private'
} as const;

export type CDNPermissionEnum = typeof CDNPermissionEnum[keyof typeof CDNPermissionEnum];
...
export interface CreateProject {
     ...
     * @memberof CreateProject
     */
    'type'?: CreateProjectTypeEnum;
}

export const CreateProjectTypeEnum = {
    Default: 'DEFAULT',
    Internal: 'INTERNAL',
    Tms: 'TMS'
} as const;

export type CreateProjectTypeEnum = typeof CreateProjectTypeEnum[keyof typeof CreateProjectTypeEnum];
...
export const FilterFieldSubFieldEnum = {
    ...
    LengthViolated: '_length_violated',
...
export interface MergeBranchRequest {
     ...
     * @memberof MergeBranchRequest
     */
    'checkMismatchedColumnType'?: boolean;
    /**
     * 
...
export const ProjectDetailTypeEnum = {
    Default: 'DEFAULT',
    Internal: 'INTERNAL',
    Tms: 'TMS'
} as const;

export type ProjectDetailTypeEnum = typeof ProjectDetailTypeEnum[keyof typeof ProjectDetailTypeEnum];
...
export const CdnApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        list: async (gridId: string, offset?: number, limit?: number, ids?: Array<string>, published?: boolean, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'gridId' is not null or undefined
            assertParamExists('list', 'gridId', gridId)
            const localVarPath = `/v1/cdns`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        publish: async (cdnId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'cdnId' is not null or undefined
            assertParamExists('publish', 'cdnId', cdnId)
            const localVarPath = `/v1/cdns/{cdnId}/publish`
                .replace(`{${"cdnId"}}`, encodeURIComponent(String(cdnId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        unPublish: async (cdnId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'cdnId' is not null or undefined
            assertParamExists('unPublish', 'cdnId', cdnId)
            const localVarPath = `/v1/cdns/{cdnId}/unpublish`
                .replace(`{${"cdnId"}}`, encodeURIComponent(String(cdnId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const CdnApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async list(gridId: string, offset?: number, limit?: number, ids?: Array<string>, published?: boolean, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<CDN>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.list(gridId, offset, limit, ids, published, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * publish
         ...
         * @throws {RequiredError}
         */
        async publish(cdnId: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CDN>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.publish(cdnId, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * unPublish
         ...
         * @throws {RequiredError}
         */
        async unPublish(cdnId: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CDN>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.unPublish(cdnId, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const CdnApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        list(gridId: string, offset?: number, limit?: number, ids?: Array<string>, published?: boolean, options?: any): AxiosPromise<Array<CDN>> {
            return localVarFp.list(gridId, offset, limit, ids, published, options).then((request) => request(axios, basePath));
        },
        /**
         * publish
         * @summary publish
         ...
         * @throws {RequiredError}
         */
        publish(cdnId: string, options?: any): AxiosPromise<CDN> {
            return localVarFp.publish(cdnId, options).then((request) => request(axios, basePath));
        },
        /**
         * unPublish
         * @summary unPublish
         ...
         * @throws {RequiredError}
         */
        unPublish(cdnId: string, options?: any): AxiosPromise<CDN> {
            return localVarFp.unPublish(cdnId, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class CdnApi extends BaseAPI {
     ...
     * @memberof CdnApi
     */
    public list(gridId: string, offset?: number, limit?: number, ids?: Array<string>, published?: boolean, options?: AxiosRequestConfig) {
        return CdnApiFp(this.configuration).list(gridId, offset, limit, ids, published, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof CdnApi
     */
    public publish(cdnId: string, options?: AxiosRequestConfig) {
        return CdnApiFp(this.configuration).publish(cdnId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof CdnApi
     */
    public unPublish(cdnId: string, options?: AxiosRequestConfig) {
        return CdnApiFp(this.configuration).unPublish(cdnId, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const TransmemApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        importTmx: async (tmId: string, file: File, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'tmId' is not null or undefined
...
export const TransmemApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async importTmx(tmId: string, file: File, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
...
export const TransmemApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        importTmx(tmId: string, file: File, options?: any): AxiosPromise<void> {
...
export class TransmemApi extends BaseAPI {
     ...
     * @memberof TransmemApi
     */
    public importTmx(tmId: string, file: File, options?: AxiosRequestConfig) {
...
export const ViewApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        _export: async (viewId: string, columnIds?: Array<string>, fileHeader?: ExportFileHeader, query?: string, sort?: string, type?: FileType, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'viewId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        importView: async (viewId: string, file: File, importRequest?: string, type?: FileType, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'viewId' is not null or undefined
         ...
         * @param {string} [branchId] branchId
         * @param {string} [gridId] gridId
         * @param {'defaultView' | 'accessView' | 'userView' | 'workflowView' | 'widgetView'} [type] type
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        list: async (branchId?: string, gridId?: string, type?: 'defaultView' | 'accessView' | 'userView' | 'workflowView' | 'widgetView', options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/v1/views`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const ViewApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async _export(viewId: string, columnIds?: Array<string>, fileHeader?: ExportFileHeader, query?: string, sort?: string, type?: FileType, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<File>> {
         ...
         * @throws {RequiredError}
         */
        async importView(viewId: string, file: File, importRequest?: string, type?: FileType, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
         ...
         * @throws {RequiredError}
         */
        async list(branchId?: string, gridId?: string, type?: 'defaultView' | 'accessView' | 'userView' | 'workflowView' | 'widgetView', options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<View>>> {
...
export const ViewApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        _export(viewId: string, columnIds?: Array<string>, fileHeader?: ExportFileHeader, query?: string, sort?: string, type?: FileType, options?: any): AxiosPromise<File> {
         ...
         * @throws {RequiredError}
         */
        importView(viewId: string, file: File, importRequest?: string, type?: FileType, options?: any): AxiosPromise<void> {
         ...
         * @throws {RequiredError}
         */
        list(branchId?: string, gridId?: string, type?: 'defaultView' | 'accessView' | 'userView' | 'workflowView' | 'widgetView', options?: any): AxiosPromise<Array<View>> {
...
export class ViewApi extends BaseAPI {
     ...
     * @memberof ViewApi
     */
    public _export(viewId: string, columnIds?: Array<string>, fileHeader?: ExportFileHeader, query?: string, sort?: string, type?: FileType, options?: AxiosRequestConfig) {
     ...
     * @memberof ViewApi
     */
    public importView(viewId: string, file: File, importRequest?: string, type?: FileType, options?: AxiosRequestConfig) {
     ...
     * @memberof ViewApi
     */
    public list(branchId?: string, gridId?: string, type?: 'defaultView' | 'accessView' | 'userView' | 'workflowView' | 'widgetView', options?: AxiosRequestConfig) {
