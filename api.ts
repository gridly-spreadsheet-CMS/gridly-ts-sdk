...
export const BranchApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        merge: async (branchId: string, destinationBranchId: string, mergeRecordOptions?: Array<'add' | 'update' | 'delete' | 'override'>, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'branchId' is not null or undefined
...
export const BranchApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async merge(branchId: string, destinationBranchId: string, mergeRecordOptions?: Array<'add' | 'update' | 'delete' | 'override'>, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Task>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.merge(branchId, destinationBranchId, mergeRecordOptions, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const BranchApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        merge(branchId: string, destinationBranchId: string, mergeRecordOptions?: Array<'add' | 'update' | 'delete' | 'override'>, options?: any): AxiosPromise<Task> {
            return localVarFp.merge(branchId, destinationBranchId, mergeRecordOptions, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class BranchApi extends BaseAPI {
     ...
     * @memberof BranchApi
     */
    public merge(branchId: string, destinationBranchId: string, mergeRecordOptions?: Array<'add' | 'update' | 'delete' | 'override'>, options?: AxiosRequestConfig) {
        return BranchApiFp(this.configuration).merge(branchId, destinationBranchId, mergeRecordOptions, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const RecordApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        fetch: async (viewId: string, columnIds?: Array<string>, page?: string, query?: string, sort?: string, fetchFileOption?: FetchFileOption, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'viewId' is not null or undefined
...
export const RecordApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async fetch(viewId: string, columnIds?: Array<string>, page?: string, query?: string, sort?: string, fetchFileOption?: FetchFileOption, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Record>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.fetch(viewId, columnIds, page, query, sort, fetchFileOption, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * update
...
export const RecordApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        fetch(viewId: string, columnIds?: Array<string>, page?: string, query?: string, sort?: string, fetchFileOption?: FetchFileOption, options?: any): AxiosPromise<Array<Record>> {
            return localVarFp.fetch(viewId, columnIds, page, query, sort, fetchFileOption, options).then((request) => request(axios, basePath));
        },
        /**
         * update
         * @summary update
...
export class RecordApi extends BaseAPI {
     ...
     * @memberof RecordApi
     */
    public fetch(viewId: string, columnIds?: Array<string>, page?: string, query?: string, sort?: string, fetchFileOption?: FetchFileOption, options?: AxiosRequestConfig) {
        return RecordApiFp(this.configuration).fetch(viewId, columnIds, page, query, sort, fetchFileOption, options).then((request) => request(this.axios, this.basePath));
    }
...
export const TransmemApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        createWithFile: async (file: any, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        importTmx: async (tmId: string, file: any, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'tmId' is not null or undefined
...
export const TransmemApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async _export(tmId: string, format?: ExportFormat, sourceLang?: string, targetLangs?: Array<string>, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<any>> {
         ...
         * @throws {RequiredError}
         */
        async createWithFile(file: any, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TransMem>> {
         ...
         * @throws {RequiredError}
         */
        async importTmx(tmId: string, file: any, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
...
export const TransmemApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        _export(tmId: string, format?: ExportFormat, sourceLang?: string, targetLangs?: Array<string>, options?: any): AxiosPromise<any> {
         ...
         * @throws {RequiredError}
         */
        createWithFile(file: any, options?: any): AxiosPromise<TransMem> {
         ...
         * @throws {RequiredError}
         */
        importTmx(tmId: string, file: any, options?: any): AxiosPromise<void> {
...
export class TransmemApi extends BaseAPI {
     ...
     * @memberof TransmemApi
     */
    public createWithFile(file: any, options?: AxiosRequestConfig) {
     ...
     * @memberof TransmemApi
     */
    public importTmx(tmId: string, file: any, options?: AxiosRequestConfig) {
...
export const ViewApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {string} [query] query
         * @param {string} [sort] sort
         * @param {'csv' | 'tsv' | 'xls' | 'xlsx' | 'json' | 'po'} [type] type
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        _export: async (viewId: string, columnIds?: Array<string>, fileHeader?: ExportFileHeader, query?: string, sort?: string, type?: 'csv' | 'tsv' | 'xls' | 'xlsx' | 'json' | 'po', options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'viewId' is not null or undefined
         ...
         * @summary importView
         * @param {string} viewId viewId
         * @param {any} file The following file types are supported: csv, tsv, xls, xlsx and json
         * @param {string} [importRequest] importRequest
         * @param {'csv' | 'tsv' | 'xls' | 'xlsx' | 'json' | 'po'} [type] type
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        importView: async (viewId: string, file: any, importRequest?: string, type?: 'csv' | 'tsv' | 'xls' | 'xlsx' | 'json' | 'po', options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'viewId' is not null or undefined
         ...
         * @param {string} [branchId] branchId
         * @param {string} [gridId] gridId
         * @param {'defaultView' | 'accessView' | 'userView'} [type] type
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        list: async (branchId?: string, gridId?: string, type?: 'defaultView' | 'accessView' | 'userView', options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/v1/views`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        merge: async (destinationViewId: string, viewId: string, mergeRecordOptions?: Array<'add' | 'update' | 'delete' | 'override'>, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const ViewApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async _export(viewId: string, columnIds?: Array<string>, fileHeader?: ExportFileHeader, query?: string, sort?: string, type?: 'csv' | 'tsv' | 'xls' | 'xlsx' | 'json' | 'po', options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<any>> {
         ...
         * @throws {RequiredError}
         */
        async importView(viewId: string, file: any, importRequest?: string, type?: 'csv' | 'tsv' | 'xls' | 'xlsx' | 'json' | 'po', options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
         ...
         * @throws {RequiredError}
         */
        async list(branchId?: string, gridId?: string, type?: 'defaultView' | 'accessView' | 'userView', options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<View>>> {
         ...
         * @throws {RequiredError}
         */
        async merge(destinationViewId: string, viewId: string, mergeRecordOptions?: Array<'add' | 'update' | 'delete' | 'override'>, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Task>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.merge(destinationViewId, viewId, mergeRecordOptions, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const ViewApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        _export(viewId: string, columnIds?: Array<string>, fileHeader?: ExportFileHeader, query?: string, sort?: string, type?: 'csv' | 'tsv' | 'xls' | 'xlsx' | 'json' | 'po', options?: any): AxiosPromise<any> {
         ...
         * @throws {RequiredError}
         */
        importView(viewId: string, file: any, importRequest?: string, type?: 'csv' | 'tsv' | 'xls' | 'xlsx' | 'json' | 'po', options?: any): AxiosPromise<void> {
         ...
         * @throws {RequiredError}
         */
        list(branchId?: string, gridId?: string, type?: 'defaultView' | 'accessView' | 'userView', options?: any): AxiosPromise<Array<View>> {
         ...
         * @throws {RequiredError}
         */
        merge(destinationViewId: string, viewId: string, mergeRecordOptions?: Array<'add' | 'update' | 'delete' | 'override'>, options?: any): AxiosPromise<Task> {
            return localVarFp.merge(destinationViewId, viewId, mergeRecordOptions, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class ViewApi extends BaseAPI {
     ...
     * @memberof ViewApi
     */
    public _export(viewId: string, columnIds?: Array<string>, fileHeader?: ExportFileHeader, query?: string, sort?: string, type?: 'csv' | 'tsv' | 'xls' | 'xlsx' | 'json' | 'po', options?: AxiosRequestConfig) {
     ...
     * @memberof ViewApi
     */
    public importView(viewId: string, file: any, importRequest?: string, type?: 'csv' | 'tsv' | 'xls' | 'xlsx' | 'json' | 'po', options?: AxiosRequestConfig) {
     ...
     * @memberof ViewApi
     */
    public list(branchId?: string, gridId?: string, type?: 'defaultView' | 'accessView' | 'userView', options?: AxiosRequestConfig) {
     ...
     * @memberof ViewApi
     */
    public merge(destinationViewId: string, viewId: string, mergeRecordOptions?: Array<'add' | 'update' | 'delete' | 'override'>, options?: AxiosRequestConfig) {
        return ViewApiFp(this.configuration).merge(destinationViewId, viewId, mergeRecordOptions, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const ViewFileApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        upload: async (viewId: string, columnId: string, recordId: string, file: any, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'viewId' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        uploadZip: async (viewId: string, columnId: string, fileMappings: string, file: any, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'viewId' is not null or undefined
...
export const ViewFileApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async download(fileId: string, viewId: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<any>> {
         ...
         * @throws {RequiredError}
         */
        async upload(viewId: string, columnId: string, recordId: string, file: any, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<UploadedFile>> {
         ...
         * @throws {RequiredError}
         */
        async uploadZip(viewId: string, columnId: string, fileMappings: string, file: any, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Record>>> {
...
export const ViewFileApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        download(fileId: string, viewId: string, options?: any): AxiosPromise<any> {
         ...
         * @throws {RequiredError}
         */
        upload(viewId: string, columnId: string, recordId: string, file: any, options?: any): AxiosPromise<UploadedFile> {
         ...
         * @throws {RequiredError}
         */
        uploadZip(viewId: string, columnId: string, fileMappings: string, file: any, options?: any): AxiosPromise<Array<Record>> {
...
export class ViewFileApi extends BaseAPI {
     ...
     * @memberof ViewFileApi
     */
    public upload(viewId: string, columnId: string, recordId: string, file: any, options?: AxiosRequestConfig) {
     ...
     * @memberof ViewFileApi
     */
    public uploadZip(viewId: string, columnId: string, fileMappings: string, file: any, options?: AxiosRequestConfig) {
