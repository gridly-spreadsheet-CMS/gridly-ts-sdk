...
export interface DateTimeFormat {
     ...
     * @memberof DateTimeFormat
     */
    'timeFormat'?: DateTimeFormatTimeFormatEnum;
    /**
     * 
     * @type {string}
     * @memberof DateTimeFormat
...
export const DateTimeFormatTimeFormatEnum = {
    Hour12: 'hour12',
    Hour24: 'hour24'
} as const;

export type DateTimeFormatTimeFormatEnum = typeof DateTimeFormatTimeFormatEnum[keyof typeof DateTimeFormatTimeFormatEnum];
...
export const RecordApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        fetchHistories: async (viewId: string, recordId: string, page?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'viewId' is not null or undefined
...
export const RecordApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async fetchHistories(viewId: string, recordId: string, page?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<RecordHistory>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.fetchHistories(viewId, recordId, page, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * update
...
export const RecordApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        fetchHistories(viewId: string, recordId: string, page?: string, options?: any): AxiosPromise<Array<RecordHistory>> {
            return localVarFp.fetchHistories(viewId, recordId, page, options).then((request) => request(axios, basePath));
        },
        /**
         * update
         * @summary update
...
export class RecordApi extends BaseAPI {
     ...
     * @memberof RecordApi
     */
    public fetchHistories(viewId: string, recordId: string, page?: string, options?: AxiosRequestConfig) {
        return RecordApiFp(this.configuration).fetchHistories(viewId, recordId, page, options).then((request) => request(this.axios, this.basePath));
    }
